...
const loginUser = asyncHandler ( async (req, res) => {
    ...
    const loggedInBuyer = await Buyer.findById(buyer._id)
    .select('-password -refreshToken')
    ...
    .json(new ApiResponse(
        200,
        {
            buyer: loggedInBuyer, accessToken, refreshToken
        },
...
const refereshAccessToken = asyncHandler(async(req, res) => {
    ...
    try {
        ...
        const {accessToken, newRefreshToken} = await generateAccessAndRefreshToken(buyer._id);
